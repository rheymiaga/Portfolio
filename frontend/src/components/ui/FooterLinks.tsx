        ...
        <div className="flex flex-col items-start gap-2 w-full">
            {socialLinks.map((link) => (
                <a className="poppins w-full" target="_blank" href={link.url} key={link.url}>
                    <div className="opacity-70 flex justify-between hover:opacity-100 p-2 text-base w-full hover:bg-neutral-700 rounded-lg gap-1 items-center relative overflow-hidden group transition-all duration-500 ease-in-out">
